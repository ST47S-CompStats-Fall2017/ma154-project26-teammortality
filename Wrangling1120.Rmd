...
knnCHRON14 <- knnHIV14 %>% mutate(CHRONknndiff = ((preds.knn.tr.CHRON14 - realknnCHRON14)/realknnCHRON14))
mortrate <- CHRON14$CHRONtreediff
cause <- rep("CHRON", 3110)
cause <- as.data.frame(cause)
model <- rep("knn", 3110)
...
knnOTHN14 <- knnHIV14 %>% mutate(OTHNknndiff = ((preds.knn.tr.OTHN14 - realknnOTHN14)/realknnOTHN14))
mortrate <- OTHN14$OTHNtreediff
cause <- rep("OTHN", 3110)
cause <- as.data.frame(cause)
model <- rep("knn", 3110)
